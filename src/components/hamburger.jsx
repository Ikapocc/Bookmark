    ...
    return(
        <>
            <nav className={`hidden max-md:grid ${isClicked ? "after:content-['*'] after:fixed after:inset-0 after:bg-gray-900 opacity-80" : ""}`}>
                ...
                <ul className={isClicked ? "fixed flex flex-col text-xl text-center mx-auto z-10 top-20 inset-x-7 text-white cursor-pointer justify-between max-h-screen" : "hidden"}>
